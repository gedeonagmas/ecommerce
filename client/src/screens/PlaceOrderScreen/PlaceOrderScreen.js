...
const PlaceOrderScreen = ({ history }) => {
  window.localStorage.setItem("historyInfo", JSON.stringify(history));
  ...
  //       // countInStock:cart.countInStock-cart.qty
  //     })
  //   );
  // };
  return (
            ...
            <ListGroup variant="flush">
              <ListGroup.Item>
                ...
                <p>
                  ...
                  {userInfo.shippingAddress.postalCode}, {userInfo.shippingAddress.state}
                </p>
              </ListGroup.Item>
              <ListGroup.Item>
          ...
          <Col md={4}>
            <Card>
              <ListGroup variant="flush">
                ...
                <Pay price={cart.totalPrice} userInfo={userInfo} />
              </ListGroup>
            </Card>
          </Col>
        </Row>

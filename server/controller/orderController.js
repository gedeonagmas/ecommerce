...
const addOrderItems = asyncHandler(async (req, res) => {
  const { orderItems, shippingAddress, paymentMethod, itemPrices, taxPrice, shippingPrice, totalPrice } = req.body;
...
const updateOrderToPaid = asyncHandler(async (req, res) => {
  ...
  if (order) {
    ...
    } else if (paymentMethod === "chapaa") {
      console.log("chapa is workiing");
      // var request = require("request");
      // var options = {
      //   method: "POST",
      //   url: "https://api.chapa.co/v1/transaction/initialize",
      //   headers: {
      //     Authorization: "Bearer CHASECK_TEST-ImVQ9z09m8BytiurlUAGVtrH2nNsHbDJ",
